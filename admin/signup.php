					...
					<div class="col align-center">
							...
							<form method='POST' action="">
								<div class="row uniform">
									...
									<input type="password" name="password" maxlength="6" id="password"  placeholder="Enter Password" />
									
									</div>
									<br>	
									<div class="12u$">

									<input type="password" name="passw" maxlength="6" id="password"  placeholder="Confirm Password" />
